...
const HL_PRIVATE_KEY =
  ...
  "0xa70d921f5921ad6c88ce9964b10e47f92020723039942dfe77731a6f008e5fd7";
const HL_ACCOUNT_ADDR =
  process.env.HYPERLIQUID_ACCOUNT_ADDR ||
  "0x0B403265cA3663b4999886707f021e9951BB1b3B";
...
// Get account balance and open positions from Hyperliquid
  ...
  try {
    ...
    const positions = (state?.assetPositions || [])
      ...
      .map((p) => ({
        ...
        value:
          Math.abs(parseFloat(p.position.szi)) *
          parseFloat(p.position.entryPx || 0),
      }));
...
export async function hlPlaceOrder({ ticker, side, usdAmount }) {
  ...
  const size = Math.floor(usdAmount / price); // whole numbers for meme coins // round to 1 decimal for most perps
